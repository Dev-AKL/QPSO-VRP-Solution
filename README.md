...
This gives reproducible simulated traffic. Later, replace `apply_traffic_scenario()` with live traffic data without changing the optimizer.

## 5. Benchmarks (for self reference)
