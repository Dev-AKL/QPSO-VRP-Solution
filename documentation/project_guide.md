...
- loads an OpenStreetMap-derived OpenFreeMap vector style with dark palette overrides;
- falls back to dark OpenStreetMap raster tiles if the vector style fails;
...
- the browser can reach `https://tile.openstreetmap.org`;
...
application. An OpenStreetMap tile issue should not change the GeoJSON route data.
